...
docker_start_container() {
  ...
  docker run --detach --name=T01_tendermint --publish=26656:26656 --publish=26657:26657 --publish=26660:26660 --restart=always --volume=/$NGRT_DATA/T01/tmdata:/tendermint ${IMAGE_TENDERMINT} node --rpc.laddr tcp://0.0.0.0:26657 --consensus.create_empty_blocks=false --proxy_app=tcp://${ip}:26658
